...
// Styles
import styles from './Styles/GridTableScreenStyle'

class GridTableScreen extends React.Component {
  constructor (props) {
    super(props)
...
export default connect(mapStateToProps, mapDispatchToProps)(GridTableScreen)
