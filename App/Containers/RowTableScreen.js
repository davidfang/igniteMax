...
// Styles
import styles from './Styles/RowTableScreenStyle'

class RowTableScreen extends React.Component {
  constructor (props) {
    super(props)
...
export default connect(mapStateToProps, mapDispatchToProps)(RowTableScreen)
